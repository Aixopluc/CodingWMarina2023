...
public class RegistreTemperatures_PART4 {
  ...
  public void tractarOpcio() {
    ...
    if (opcion.equals("RT") || opcion.equals("rt")){
      registreTemperaturesSetmanals();
    }
    else if (opcion.equals("MJ")|| opcion.equals("mj")){
      mostrarMitjana();
    }
    else if(opcion.equals("DF") || opcion.equals("df")){
      mostrarDiferencia();
    } else if (opcion.equals("FI") || opcion.equals("fi")){
      finalitzarExecucio();
    }
    else {
      System.out.print("Escribe una opción valida: ");
      tractarOpcio();
    }
  }
